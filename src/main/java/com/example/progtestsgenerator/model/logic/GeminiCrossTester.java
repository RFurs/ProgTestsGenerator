...
public class GeminiCrossTester extends CrossTester {

    private final GeminiApiClient apiClient;

    public GeminiCrossTester(GeminiApiClient apiClient) {
    ...
    private String buildClassificationPrompt(int level) {
        return """
            ...
            Jeigu visi klausimai atitinka %d lygį – grąžink n/n, kur n yra klausimų skaičius.
    ...
    private String buildCorrectnessPrompt() {
        return """
            ...
            Išvesties formatas:
            m/n
            Klausimas pavadinimu ,,X`` neteisingas. Teisingas atsakymas yra Y
            """;
    }
}
